    ...
    return (
        <>
            <Col style={{padding: '5px'}}>
                <Row>
                    <Input placeholder="Введите число или подстроку"
                           onChange={(event) => ChangeInput(event.target.value)}/>
                </Row>
                <Row style={{paddingTop: '5px'}}>
                    <Button onClick={SearchByLength}>Поиск по длине</Button>
                </Row>
                <Row style={{paddingTop: '5px'}}>
                    <Button onClick={SearchBySubstring}>Поиск по подстроке</Button>
                    <Checkbox value={checkbox}
                              onChange={(Event) => Checked(Event.target.checked)}
                              style={{margin: '5px'}}>Чувствительность по регистру</Checkbox>
                </Row>
                <Row style={{paddingTop: '5px'}}>
